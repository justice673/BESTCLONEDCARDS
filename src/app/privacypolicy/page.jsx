  ...
  return (
    ...
    <div className={styles.container}>
      <section className={styles.section}>
        ...
        <p>Suggested text: Our website address is: <Link href={"/"}>https://bestclonecards.com.</Link> </p>
      </section>
      ...
      <section className={styles.section}>
        <h2 className={styles.heading}>Embedded content from other websites</h2>
      ...
      <section className={styles.section}>
        <h2 className={styles.heading}>Who we share your data with</h2>
        <p>Suggested text: If you request a password reset, your IP address will be included in the reset email.</p>
      </section>
      <section className={styles.section}>
        <h2 className={styles.heading}>How long we retain your data</h2>
      ...
      <section className={styles.section}>
        <h2 className={styles.heading}>What rights you have over your data</h2>
      ...
      <section className={styles.section}>
        <h2 className={styles.heading}>Where your data is sent</h2>
